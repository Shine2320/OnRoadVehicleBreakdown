...
public class Publicviewpetrolpump extends AppCompatActivity implements JsonResponse{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_publicviewpetrolpump);

        l1=(ListView)findViewById(R.id.lvview);

        JsonReq JR=new JsonReq();
        JR.json_response=(JsonResponse)Publicviewpetrolpump.this;
        String q="/publicviewpetrolpump";
        q=q.replace(" ","%20");
        JR.execute(q);
    }
