...
public class Mechanicviewuserdetailss extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ListView l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanicviewuserdetailss);

        l1=(ListView)findViewById(R.id.lvview);
        l1.setOnItemClickListener(this);

        JsonReq JR=new JsonReq();
        JR.json_response=(JsonResponse)Mechanicviewuserdetailss.this;
        String q="/mechanicviewuserdetails?uid="+Mechanicviewrequest.uids;
        q=q.replace(" ","%20");
        JR.execute(q);
    }
        ...
        try {
            ...
            if(status.equalsIgnoreCase("success")){
                ...
                for(int i = 0;i<ja1.length();i++)
                {
                    ...
                    shopname[i]=ja1.getJSONObject(i).getString("firstname")+" "+ja1.getJSONObject(i).getString("lastname");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Mechanicviewuserdetailss.this);
