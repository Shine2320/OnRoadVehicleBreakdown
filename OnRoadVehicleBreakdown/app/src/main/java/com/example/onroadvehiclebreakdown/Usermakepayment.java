...
public class Usermakepayment extends AppCompatActivity implements JsonResponse{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e5.setText(Userviewrequest.amounts);
        e5.setEnabled(false);
            ...
            public void onClick(View v) {
                ...
                if (e1.getText().toString().equalsIgnoreCase("")) {
                    Toast.makeText(getApplicationContext(),
                            "Enter The Fields", Toast.LENGTH_LONG).show();
                    e1.setError("Enter The Fields");
                    ...
                    Toast.makeText(getApplicationContext(),
                            "Enter The Fields", Toast.LENGTH_LONG).show();
                    e2.setError("Enter The Fields");
                    e2.setFocusable(true);

                } else if (e2.getText().toString().length() != 3) {
                    Toast.makeText(getApplicationContext(), "Enter 3 Digit",
                            Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(getApplicationContext(),
                            "Enter The Fields", Toast.LENGTH_LONG).show();
                    e3.setError("Enter The Fields");
                    e3.setFocusable(true);
                } else if (e4.getText().toString().equalsIgnoreCase("")) {
                    Toast.makeText(getApplicationContext(),
                            "Enter The Fields", Toast.LENGTH_LONG).show();
                    e4.setError("Enter The Fields");
                    ...
                    String q = "/usermakepayment?rid=" + Userviewrequest.rids + "&amount=" + Userviewrequest.amounts;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
                }
            }
